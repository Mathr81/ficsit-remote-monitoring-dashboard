    ...
    useEffect(() => {
        if (buildingsData) {
            if (buildingsData.IsConfigured === false) {
                setStep(0);
            } else if (buildingsData.IsProducing === false && buildingsData.IsPaused === true) {
                setStep(1);
            } else {
                setStep(2);
            }
    ...
    return (
        <Container sx={{ paddingTop: '50px' }}>
            ...
            <Grid container spacing={2} sx={{ marginBottom: '30px' }}>
                <Grid item xs>
                    <Card>
                        <CardHeader title={buildingsData.Recipe} subheader="Currently Producing" />
                    </Card>
                </Grid>
                <Grid item xs>
                    <Card>
                ...
                <Grid item xs>
                    <Card>
                        <CardHeader title={buildingsData.CircuitID} subheader="Power Circuit" />
                    </Card>
                </Grid>
