...
export const Start: React.FC = () => {
    const { value: itemSelection, setValue: setItemSelection } = useLocalStorage<string[]>(
        'srmd_ItemList',
        ['Concrete', 'Iron Ingot', 'Copper Ingot', 'Coal']
    );
    ...
    const gameResources = objectEntriesToObjectHelper<GameClassNamesEnum, GameItems>(
    ...
    return (
        <Container sx={{ paddingTop: '50px' }}>
            ...
            <Typography marginBottom="50px" level="h4" color="neutral" fontWeight={400}>
