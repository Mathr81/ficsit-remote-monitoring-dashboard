import { Box, Card, CardContent, Container, Grid, Skeleton, Stack, Typography } from '@mui/joy';
...
export const AwesomeSink: React.FC = () => {
    ...
    const { data: sinkResource } = useAutoRefetch<AwesomeSinkDto[], AwesomeSinkFm[]>(
        EndpointEnum.AWESOME_SINK_RESOURCE
    );

    const { data: sinkExploration } = useAutoRefetch<AwesomeSinkDto[], AwesomeSinkFm[]>(
